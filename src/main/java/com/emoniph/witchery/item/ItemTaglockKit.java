...
public class ItemTaglockKit extends ItemBase {
   ...
   public boolean onItemUseFirst(ItemStack itemstack, EntityPlayer player, World world, int x, int y, int z, int side, float hitX, float hitY, float hitZ) {
      ...
      if(block != Blocks.bed && block != Witchery.Blocks.COFFIN && !block.getUnlocalizedName().equals("tile.blockCarpentersBed")) {
         TileEntity tile1;
         String username1;
   ...
   public void onEntityInteract(World world, EntityPlayer player, ItemStack stack, EntityInteractEvent event) { //Banka DNK
